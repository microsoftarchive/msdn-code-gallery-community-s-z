...
namespace WindowsVersion
{
    public class Forecast : INotifyPropertyChanged
    {
        ...
        /// </summary>
        public async void GetForecast(string latitude, string longitude)
        {
            //// form the URI
            ...
            try
            {
                HttpResponseMessage response = await httpClient.GetAsync(fullUri.Uri);
                await DisplayOutput(response);
        ...
        async Task DisplayOutput(HttpResponseMessage response)
        {
            Stream stream = await response.Content.ReadAsStreamAsync();
            HandleForecastResponse(stream);
        }
        ...
        private void HandleForecastResponse(Stream text)
        {
            ...
            try
            {
                ...
                //TODO figure out this call to BeginInvoke
