...
namespace Microsoft.Example.Circuits
{
	...
	/// </remarks>
	public partial class CircuitsHelpKeywordHelper : CircuitsHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new CircuitsHelpKeywordHelper.
		/// </summary>
		protected CircuitsHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CircuitsHelpKeywordHelper.
		/// </summary>
		public static CircuitsHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class CircuitsHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CircuitsHelpKeywordHelperBase.
		/// </summary>
		protected CircuitsHelpKeywordHelperBase()
			: base() { }
