...
namespace Microsoft.Example.Circuits.DslPackage
{
	...
	/// </summary>
	internal partial class CircuitsCommandSet : CircuitsCommandSetBase
	{
		/// <summary>
		/// Constructs a new CircuitsCommandSet.
		/// </summary>
		public CircuitsCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CircuitsCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CircuitsCommandSetBase.
		/// </summary>
		protected CircuitsCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewCircuitsExplorerCommand,
				typeof(CircuitsEditorFactory).GUID);
		...
		{
			CircuitsExplorerToolWindow explorer = this.CircuitsExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentCircuitsDocData != null && this.CurrentCircuitsDocData.Store != null)
			{
				this.CurrentCircuitsDocData.ValidationController.Validate(this.CurrentCircuitsDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentCircuitsDocData != null && this.CurrentCircuitsDocData.Store != null)
			{
				...
				this.CurrentCircuitsDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected CircuitsDocData CurrentCircuitsDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CircuitsDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CircuitsDocView CurrentCircuitsDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CircuitsDocView;
			}
		}
		...
		/// </summary>
		protected CircuitsExplorerToolWindow CircuitsExplorerToolWindow
		{
			get
			{
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(CircuitsExplorerToolWindow), true) as CircuitsExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				CircuitsExplorerToolWindow explorerWindow = this.CircuitsExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class CircuitsClipboardCommandSet : CircuitsClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new CircuitsClipboardCommandSet.
		/// </summary>
		public CircuitsClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class CircuitsClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new CircuitsClipboardCommandSetBase.
		/// </summary>
		protected CircuitsClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
