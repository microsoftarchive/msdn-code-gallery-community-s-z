...
namespace Microsoft.Example.Circuits.DslPackage
{
    ...
    public override int SetUntitledDocPath(string fileName)
    {
      return base.SetUntitledDocPath(fileName);
		...
		/// </summary>
		public CircuitsDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a Circuits document in memory.
	/// </summary>
	internal abstract partial class CircuitsDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new CircuitsDocDataBase.
		/// </summary>
		protected CircuitsDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Microsoft.Example.Circuits.CircuitsDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Microsoft.Example.Circuits.CircuitsDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(CircuitsExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Microsoft.Example.Circuits.CircuitsDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Microsoft.Example.Circuits.CircuitsDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Microsoft.Example.Circuits.ComponentModel modelRoot = null;
			...
			global::Microsoft.Example.Circuits.CircuitsDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Microsoft.Example.Circuits.CircuitsSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Microsoft.Example.Circuits.CircuitsDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Microsoft.Example.Circuits.CircuitsDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::Microsoft.Example.Circuits.CircuitsDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Microsoft.Example.Circuits.ComponentModel modelRoot = (global::Microsoft.Example.Circuits.ComponentModel)this.RootElement;
			...
			{
				global::Microsoft.Example.Circuits.ComponentDiagram diagram = diagrams[0] as global::Microsoft.Example.Circuits.ComponentDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Microsoft.Example.Circuits.CircuitsSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Microsoft.Example.Circuits.CircuitsSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Microsoft.Example.Circuits.CircuitsDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Microsoft.Example.Circuits.CircuitsSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Microsoft.Example.Circuits.ComponentModel modelRoot = this.RootElement as global::Microsoft.Example.Circuits.ComponentModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Microsoft.Example.Circuits.CircuitsSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
