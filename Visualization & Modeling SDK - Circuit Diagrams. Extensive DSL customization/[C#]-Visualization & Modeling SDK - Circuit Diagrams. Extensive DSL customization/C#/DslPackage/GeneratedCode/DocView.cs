...
namespace Microsoft.Example.Circuits.DslPackage
{
	...
	/// </summary>
	internal partial class CircuitsDocView : CircuitsDocViewBase
	{
		/// <summary>
		/// Constructs a new CircuitsDocView.
		/// </summary>
		public CircuitsDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CircuitsDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CircuitsDocView.
		/// </summary>
		protected CircuitsDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			CircuitsDocDataBase docData = this.DocData as CircuitsDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for CircuitsDocViewBase should be an CircuitsDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Microsoft.Example.Circuits.ComponentDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Microsoft.Example.Circuits.ComponentDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.Example.Circuits.CircuitsToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Microsoft.Example.Circuits.CircuitsToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.CircuitsDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Microsoft.Example.Circuits.CircuitsHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Microsoft.Example.Circuits.CircuitsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Microsoft.Example.Circuits.CircuitsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
