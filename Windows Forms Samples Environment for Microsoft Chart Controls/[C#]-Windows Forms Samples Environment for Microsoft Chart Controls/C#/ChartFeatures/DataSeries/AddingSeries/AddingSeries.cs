...
namespace WinFormsChartSamples
{
	...
	/// </summary>
	public class AddingSeries : System.Windows.Forms.UserControl
	{
		...
		{
			if(Chart1.Series.Count >= charts.Length)
		...
		private void AddingSeries_Load(object sender, System.EventArgs e)
		{
