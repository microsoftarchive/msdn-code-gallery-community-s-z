...
{
    /// <summary>
    /// Simple wrapper method for MessageBox that at the very least
    /// make asking users questions easy plus default to the No button
    /// yet you can override this behavior too.
    /// </summary>
