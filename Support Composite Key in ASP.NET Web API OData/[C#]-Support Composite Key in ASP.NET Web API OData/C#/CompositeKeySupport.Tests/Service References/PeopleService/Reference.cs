...
// Original file name:
// Generation date: 2013/2/5 16:05:05
namespace CompositeKeySupport.Tests.PeopleService
{
    ...
    public partial class Container : global::System.Data.Services.Client.DataServiceContext
    {
        ...
        {
            if (typeName.StartsWith("CompositeKeySupport.Models", global::System.StringComparison.Ordinal))
            {
                return this.GetType().Assembly.GetType(string.Concat("CompositeKeySupport.Tests.PeopleService", typeName.Substring(26)), false);
            }
            return null;
        }
        /// <summary>
        ...
        {
            if (clientType.Namespace.Equals("CompositeKeySupport.Tests.PeopleService", global::System.StringComparison.Ordinal))
            {
                return string.Concat("CompositeKeySupport.Models.", clientType.Name);
            }
            return null;
        }
        /// <summary>
    ...
    /// <summary>
    /// There are no comments for CompositeKeySupport.Models.Person in the schema.
    /// </summary>
    /// <KeyProperties>
    /// FirstName
    /// LastName
