...
{
	[ExportViewModel("LinearGraphViewModel")]
	[PartCreationPolicy(CreationPolicy.Shared)]
	public class LinearGraphViewModel : GraphBaseViewModel
	{
		#region ChartMain property

		public static readonly DependencyProperty ChartMainProperty = DependencyProperty.RegisterAttached("ChartMain", typeof(Chart), typeof(LinearGraphControl), new PropertyMetadata(new PropertyChangedCallback(OnChartMainPropertyChangedCallback)));
		...
		public static readonly DependencyProperty LayoutRootGridProperty = DependencyProperty.RegisterAttached("LayoutRootGrid", typeof(Grid), typeof(LinearGraphControl), new PropertyMetadata(new PropertyChangedCallback(OnLayoutRootGridPropertyChangedCallback)));
		...
		public static readonly DependencyProperty ChartVolumeProperty = DependencyProperty.RegisterAttached("ChartVolume", typeof(Chart), typeof(LinearGraphControl), new PropertyMetadata(new PropertyChangedCallback(OnChartVolumePropertyChangedCallback)));
		...
		public string LinearChartTitle { get; set; }
		...
		public LinearGraphViewModel(MainPageViewModel mainPageViewModel)
			: base()
		{
			MainPageViewModel = mainPageViewModel;

			LinearChartTitle = Resources.Resources.CandlestickTitle;
		...
		private LineSeries _linearSeries;
		internal LineSeries LinearSeries
		{
			get
			{
				...
				if (null == _linearSeries)
				{
					_linearSeries = (LineSeries)_chartMain.Series[0];
				}

				return _linearSeries;
			}
		}
