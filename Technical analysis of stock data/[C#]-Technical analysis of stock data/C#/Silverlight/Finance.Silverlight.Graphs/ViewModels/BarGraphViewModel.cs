...
{
	[ExportViewModel("BarGraphViewModel")]
	[PartCreationPolicy(CreationPolicy.Shared)]
	public class BarGraphViewModel : GraphBaseViewModel
	{
		#region ChartMain property

		public static readonly DependencyProperty ChartMainProperty = DependencyProperty.RegisterAttached("ChartMain", typeof(Chart), typeof(BarGraphControl), new PropertyMetadata(new PropertyChangedCallback(OnChartMainPropertyChangedCallback)));
		...
		public static readonly DependencyProperty LayoutRootGridProperty = DependencyProperty.RegisterAttached("LayoutRootGrid", typeof(Grid), typeof(BarGraphControl), new PropertyMetadata(new PropertyChangedCallback(OnLayoutRootGridPropertyChangedCallback)));
		...
		public static readonly DependencyProperty ChartVolumeProperty = DependencyProperty.RegisterAttached("ChartVolume", typeof(Chart), typeof(BarGraphControl), new PropertyMetadata(new PropertyChangedCallback(OnChartVolumePropertyChangedCallback)));
		...
		public string BarChartTitle { get; set; }
		...
		public BarGraphViewModel(MainPageViewModel mainPageViewModel)
			: base()
		{
			MainPageViewModel = mainPageViewModel;

			BarChartTitle    = Resources.Resources.BarChartLabel;
		...
		private StockBarSeries _stockBarSeries;
		internal StockBarSeries StockBarSeries
		{
			get
			{
				...
				if (null == _stockBarSeries)
				{
					_stockBarSeries = (StockBarSeries)_chartMain.Series[0];
				}

				return _stockBarSeries;
			}
		}
