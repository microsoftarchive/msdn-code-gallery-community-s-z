<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="SamlIdPInitiated.IdentityProvider.Default" %>
...
<body>
	<form id="myform" runat="server">
		<div class="templatecontent">
			...
			<h4>
				<b>IdpInitiated - IdentityProvider</b></h4>
			<br />
			<br />
