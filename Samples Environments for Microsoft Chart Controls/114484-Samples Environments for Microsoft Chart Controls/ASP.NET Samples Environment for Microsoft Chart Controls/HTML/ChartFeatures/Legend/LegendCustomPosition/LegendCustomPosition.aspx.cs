...
namespace System.Web.UI.DataVisualization.Charting.Samples
{
	...
	/// </summary>
	public partial class LegendCustomPosition : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                Chart1.Legends[0].Position.X = float.Parse(TextBoxX.Text);
                Chart1.Legends[0].Position.Y = float.Parse(TextBoxY.Text);
                Chart1.Legends[0].Position.Width = float.Parse(TextBoxWidth.Text);
                Chart1.Legends[0].Position.Height = float.Parse(TextBoxHeight.Text);
			}
			catch(Exception exception)
			{
                ...
                Chart1.Legends[0].Position.Width = 56;
                Chart1.Legends[0].Position.Height = 10;
			}

			// Set text fields values
            TextBoxX.Text = Chart1.Legends[0].Position.X.ToString();
            TextBoxY.Text = Chart1.Legends[0].Position.Y.ToString();
            TextBoxWidth.Text = Chart1.Legends[0].Position.Width.ToString();
            TextBoxHeight.Text = Chart1.Legends[0].Position.Height.ToString();
		...
		private void Chart1_Click(object sender, System.Web.UI.WebControls.ImageMapEventArgs e)
		{
            ...
            Chart1.Legends[0].Position.X = point.X * 100F / ((float)(Chart1.Width.Value - 1));
            Chart1.Legends[0].Position.Y = point.Y * 100F / ((float)(Chart1.Height.Value - 1));
		...
		{
            if (Chart1.Legends[0].Position.X > 42)
                Chart1.Legends[0].Position.Width = 56;

            if (Chart1.Legends[0].Position.Y > 90)
                Chart1.Legends[0].Position.Height = 10;
		}
