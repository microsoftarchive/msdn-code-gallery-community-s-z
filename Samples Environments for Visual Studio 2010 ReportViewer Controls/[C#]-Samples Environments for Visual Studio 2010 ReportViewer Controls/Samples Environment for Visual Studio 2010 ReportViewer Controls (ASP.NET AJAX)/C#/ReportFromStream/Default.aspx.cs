...
namespace ReportFromStream
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //       If you have a licensed copy of SQL Server 2008 Reporting Services or later, you can also use the RDL object model 
            //       (Microsoft.ReportingServices.RdlObjectModel.Report) to generate a server report.
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    report = new FileStream(Server.MapPath("OrdersWithSubreport.rdlc"), FileMode.Open, FileAccess.Read);
                    ...
                    subreport = new FileStream(Server.MapPath("OrderDetails.rdlc"), FileMode.Open, FileAccess.Read);
