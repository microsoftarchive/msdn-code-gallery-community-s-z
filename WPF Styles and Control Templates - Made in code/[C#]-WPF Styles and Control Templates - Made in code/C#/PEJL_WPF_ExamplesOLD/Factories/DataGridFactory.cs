...
namespace PEJL_WPF_Examples.Factories
{
    class DataGridFactory
    {
        ...
        Style MakeDataGridColumnHeaderStyle()
        {
            ...
            border.SetValue(DataGridHeaderBorder.BorderThicknessProperty, new TemplateBindingExtension(Control.BorderThicknessProperty));
            border.SetValue(DataGridHeaderBorder.BackgroundProperty, new TemplateBindingExtension(Control.BackgroundProperty));
            ...
            border.SetValue(DataGridHeaderBorder.PaddingProperty, new TemplateBindingExtension(Control.PaddingProperty));
            ...
            contentPresenter.SetValue(Control.HorizontalAlignmentProperty, new TemplateBindingExtension(Control.HorizontalContentAlignmentProperty));
            contentPresenter.SetValue(Control.SnapsToDevicePixelsProperty, new TemplateBindingExtension(Control.SnapsToDevicePixelsProperty));
            contentPresenter.SetValue(Control.VerticalAlignmentProperty, new TemplateBindingExtension(Control.VerticalContentAlignmentProperty));

            contentPresenter.AddHandler(Grid.MouseEnterEvent, new MouseEventHandler(ColumnHeader_MouseEnter));
            contentPresenter.AddHandler(Grid.MouseLeaveEvent, new MouseEventHandler(ColumnHeader_MouseLeave));
            ...
            thumb1.SetValue(Control.HorizontalAlignmentProperty, HorizontalAlignment.Left);
            thumb1.SetValue(Control.StyleProperty, MakeColumnHeaderGripperStyle());

            var thumb2 = new FrameworkElementFactory(typeof(Thumb));
            thumb2.SetValue(FrameworkElement.NameProperty, "PART_RightHeaderGripper");
            thumb2.SetValue(Control.HorizontalAlignmentProperty, HorizontalAlignment.Right);
            thumb2.SetValue(Control.StyleProperty, MakeColumnHeaderGripperStyle());
        ...
        Style MakeColumnHeaderGripperStyle()
        {
            ...
            style.Setters.Add(new Setter(Control.WidthProperty, 8.0D));
            style.Setters.Add(new Setter(Control.BackgroundProperty, Brushes.Transparent));
            style.Setters.Add(new Setter(Control.CursorProperty, Cursors.ScrollWE));
            style.Setters.Add(new Setter(Control.TemplateProperty, template));
