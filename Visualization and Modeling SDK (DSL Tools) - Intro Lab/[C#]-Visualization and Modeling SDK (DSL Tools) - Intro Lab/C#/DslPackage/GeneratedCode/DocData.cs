...
namespace CompanyName.LanguageSm
{
	...
	/// </summary>
	internal partial class LanguageSmDocData : LanguageSmDocDataBase
	{
		/// <summary>
		/// Constructs a new LanguageSmDocData.
		/// </summary>
		public LanguageSmDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a LanguageSm document in memory.
	/// </summary>
	internal abstract partial class LanguageSmDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new LanguageSmDocDataBase.
		/// </summary>
		protected LanguageSmDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::CompanyName.LanguageSm.LanguageSmDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::CompanyName.LanguageSm.LanguageSmDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::CompanyName.LanguageSm.LanguageSmDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::CompanyName.LanguageSm.LanguageSmDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::CompanyName.LanguageSm.ExampleModel modelRoot = null;
			...
			global::CompanyName.LanguageSm.LanguageSmDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::CompanyName.LanguageSm.LanguageSmSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::CompanyName.LanguageSm.LanguageSmDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::CompanyName.LanguageSm.LanguageSmDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override string SerializedModel
		{
			get
			{
				global::CompanyName.LanguageSm.ExampleModel modelRoot = this.RootElement as global::CompanyName.LanguageSm.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::CompanyName.LanguageSm.LanguageSmSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
