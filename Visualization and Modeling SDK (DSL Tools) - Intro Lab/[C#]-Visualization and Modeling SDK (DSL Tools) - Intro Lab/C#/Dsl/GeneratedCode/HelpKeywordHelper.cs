...
namespace CompanyName.LanguageSm
{
	...
	/// </remarks>
	public partial class LanguageSmHelpKeywordHelper : LanguageSmHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LanguageSmHelpKeywordHelper.
		/// </summary>
		protected LanguageSmHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LanguageSmHelpKeywordHelper.
		/// </summary>
		public static LanguageSmHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class LanguageSmHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LanguageSmHelpKeywordHelperBase.
		/// </summary>
		protected LanguageSmHelpKeywordHelperBase()
			: base() { }
