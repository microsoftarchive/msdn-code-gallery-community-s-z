...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "CompanyName.LanguageSm.LanguageSmDiagram")]

namespace CompanyName.LanguageSm
{
	/// <summary>
	/// DomainClass LanguageSmDiagram
	/// Description for CompanyName.LanguageSm.LanguageSmDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("CompanyName.LanguageSm.LanguageSmDiagram.DisplayName", typeof(global::CompanyName.LanguageSm.LanguageSmDomainModel), "CompanyName.LanguageSm.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("CompanyName.LanguageSm.LanguageSmDiagram.Description", typeof(global::CompanyName.LanguageSm.LanguageSmDomainModel), "CompanyName.LanguageSm.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::CompanyName.LanguageSm.LanguageSmDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("899d609b-c5ed-4ee0-92ed-d982cf839725")]
	public partial class LanguageSmDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::CompanyName.LanguageSm.LanguageSmToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::CompanyName.LanguageSm.ExampleElement)
			{
				global::CompanyName.LanguageSm.ExampleShape newShape = new global::CompanyName.LanguageSm.ExampleShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::CompanyName.LanguageSm.ExampleElementReferencesTargets)
			{
				global::CompanyName.LanguageSm.ExampleConnector newShape = new global::CompanyName.LanguageSm.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::CompanyName.LanguageSm.ExampleShape.DecoratorsInitialized += ExampleShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		internal static partial class ExampleShapeDecoratorMap
		{
			...
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::CompanyName.LanguageSm.ExampleElement.NameDomainPropertyId);
		...
		private global::CompanyName.LanguageSm.ExampleRelationshipConnectAction exampleRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::CompanyName.LanguageSm.LanguageSmToolboxHelper.ExampleRelationshipFilterString))
				{
					if (this.exampleRelationshipConnectAction == null)
					{
						this.exampleRelationshipConnectAction = new global::CompanyName.LanguageSm.ExampleRelationshipConnectAction(this);
		...
		/// <summary>
		/// LanguageSmDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x899d609b, 0xc5ed, 0x4ee0, 0x92, 0xed, 0xd9, 0x82, 0xcf, 0x83, 0x97, 0x25);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public LanguageSmDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public LanguageSmDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace CompanyName.LanguageSm
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::CompanyName.LanguageSm.ExampleElementReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::CompanyName.LanguageSm.ExampleElement), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::CompanyName.LanguageSm.ExampleElement)
				{
					parentElement = GetParentForExampleElement((global::CompanyName.LanguageSm.ExampleElement)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::CompanyName.LanguageSm.ExampleModel GetParentForExampleElement( global::CompanyName.LanguageSm.ExampleElement root )
			{
				// Segments 0 and 1
				global::CompanyName.LanguageSm.ExampleModel result = root.ExampleModel;
