...
namespace CompanyName.LanguageSm
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::CompanyName.LanguageSm.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::CompanyName.LanguageSm.ExampleElement)
				{
					if (candidateTarget is global::CompanyName.LanguageSm.ExampleElement)
					{
						global::CompanyName.LanguageSm.ExampleElement sourceExampleElement = (global::CompanyName.LanguageSm.ExampleElement)candidateSource;
						global::CompanyName.LanguageSm.ExampleElement targetExampleElement = (global::CompanyName.LanguageSm.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::CompanyName.LanguageSm.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::CompanyName.LanguageSm.ExampleElement)
				{
					if (target is global::CompanyName.LanguageSm.ExampleElement)
					{
						global::CompanyName.LanguageSm.ExampleElement sourceAccepted = (global::CompanyName.LanguageSm.ExampleElement)source;
						global::CompanyName.LanguageSm.ExampleElement targetAccepted = (global::CompanyName.LanguageSm.ExampleElement)target;
						DslModeling::ElementLink result = new global::CompanyName.LanguageSm.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
