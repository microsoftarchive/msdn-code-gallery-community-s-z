...
namespace CompanyName.LanguageSm
{
	...
	/// </remarks>
	public partial class LanguageSmToolboxHelper : LanguageSmToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new LanguageSmToolboxHelper.
		/// </summary>
		public LanguageSmToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class LanguageSmToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify LanguageSm toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "LanguageSm.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new LanguageSmToolboxHelperBase.
		/// </summary>
		protected LanguageSmToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::CompanyName.LanguageSm.LanguageSmDomainModel.SingletonResourceManager.GetString("LanguageSmToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "CompanyName.LanguageSm.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"CompanyName.LanguageSm.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"CompanyName.LanguageSm.LanguageSmToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("LanguageSmToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::CompanyName.LanguageSm.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "CompanyName.LanguageSm.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"CompanyName.LanguageSm.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::CompanyName.LanguageSm.LanguageSmDomainModel));
