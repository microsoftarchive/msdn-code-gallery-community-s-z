...
namespace MvcWebApp.Areas.Lookup.Controllers {
    #region
    ...
    public class ManagementController : BaseController {
        ...
        private Image AttachModelImage(HttpPostedFileBase file)
        {
            Image image = null;
            if (file != null) {
                var fileContext = new byte[file.ContentLength];
        ...
        public ActionResult CreateHomeType(int? id)
        {
            ...
            if (id != null) {
                var list =
                    _wcfService.InvokeService<IVirtueContextService, ICollection<HomeType>>(
                        svc => svc.GetHomeTypes(true));
