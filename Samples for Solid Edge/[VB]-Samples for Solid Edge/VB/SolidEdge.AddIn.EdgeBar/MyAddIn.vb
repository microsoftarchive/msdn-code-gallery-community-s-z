...
Namespace SolidEdge.AddIn.EdgeBar
    <Guid("CB9172F1-306D-44DE-BCD6-AA0C6901B14E"), ProgId("SolidEdge.AddIn.EdgeBar"), ComVisible(True), AddInInfo("CodePlex EdgeBar Addin", "Solid Edge Addin in .NET 4.0."), AddInEnvironmentCategory(CategoryIDs.CATID_SEApplication), AddInEnvironmentCategory(CategoryIDs.CATID_SEAllDocumentEnvrionments), AddInAutoConnect(True)> _
...
#Region "SolidEdgeFramework.ISolidEdgeAddIn"
        ...
        Public Sub OnConnection(ByVal Application As Object, ByVal ConnectMode As SolidEdgeFramework.SeConnectMode, ByVal AddInInstance As SolidEdgeFramework.AddIn) Implements SolidEdgeFramework.ISolidEdgeAddIn.OnConnection
            ...
            _edgeBarController = New EdgeBarController(Me)
