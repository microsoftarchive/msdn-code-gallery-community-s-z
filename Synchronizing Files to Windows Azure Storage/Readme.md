...
<pre class="hidden">public override ItemMetadataSchema MetadataSchema
{
    get
    {
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div>
<span class="hidden">csharp</span>
<pre class="hidden">// Enumerate all items in the store
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div>
<span class="hidden">csharp</span>
<pre class="hidden">internal List&lt;ItemFieldDictionary&gt; ListBlobs()
{
...
<p>At this point, I want to talk briefly about the store wrapper class.&nbsp; The store wrapper class utilizes objects in the Microsoft.WindowsAzure.StorageClient namespace.&nbsp; To get that you&rsquo;ll need to download
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">Edit</span>|<span class="pluginRemoveHolderLink">Remove</span></div>
<span class="hidden">csharp</span>
<pre class="hidden">internal void DeleteFile(
    string name,
