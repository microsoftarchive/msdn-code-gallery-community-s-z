...
Partial Public NotInheritable Class Sheet2
    ...
    Friend WithEvents StatusValuesList As Microsoft.Office.Tools.Excel.ListObject

    Friend WithEvents StatusValuesRange As Microsoft.Office.Tools.Excel.NamedRange
    ...
    Private Sub BeginInitialization()
        Me.BeginInit()
        Me.StatusValuesList.BeginInit()
        Me.StatusValuesRange.BeginInit()
    End Sub
    ...
    Private Sub EndInitialization()
        Me.StatusValuesRange.EndInit()
        Me.StatusValuesList.EndInit()
        Me.EndInit()
    End Sub
    ...
    Private Sub InitializeControls()
        Me.StatusValuesList = Globals.Factory.CreateListObject(Nothing, Nothing, "Sheet2:StatusValuesList", "StatusValuesList", Me)
        Me.StatusValuesRange = Globals.Factory.CreateNamedRange(Nothing, Nothing, "StatusValuesRange", "StatusValuesRange", Me)
    End Sub
    ...
    Protected Overrides Sub OnShutdown()
        Me.StatusValuesRange.Dispose()
        Me.StatusValuesList.Dispose()
        MyBase.OnShutdown()
    End Sub
End Class
