...
namespace ConfigureSample
{
    class Program
    {
        ...
        {
            const string rpName = "Username Binding Sample RP";
            const string rpRealm = "http://localhost:7100/Service/Default.aspx";
            const string serviceIdentityName = "acssample";
            const string serviceIdentityPassword = "pass@word1";
            const string ruleGroupName = "Default rule group for Username Binding Sample RP";
